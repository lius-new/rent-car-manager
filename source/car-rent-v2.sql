...
--
-- Current Database: `car-rent`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `car-rent` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
INSERT INTO `car` VALUES (2,'梅赛德斯-迈巴赫 ',4,'歪新人,飞船',NULL,0,NULL),(3,'宝马 M760i',4,'关于坐骑,日骑千里',NULL,0,NULL),(4,'劳斯莱斯',6,'劳动所得',NULL,0,NULL),(5,'宾利',7,'冰刀利车,雪地专用',NULL,0,NULL),(6,'奥迪R8',8,'校长的架坐',NULL,0,NULL),(7,'马自达',19,'我开马自达,你开什么车来的',NULL,0,1),(8,'五令红光',19,'五菱神车',NULL,0,NULL);
...
CREATE TABLE `rent` (
  ...
  `rent_start_date` int(11) DEFAULT NULL COMMENT '租借开始时间',
  `rent_end_date` int(11) DEFAULT NULL COMMENT '租借结束时间',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='车辆租借表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rent` VALUES (1,19,7,NULL,NULL);
...
INSERT INTO `user` VALUES (4,'admin','admin',NULL,'ADMIN',0),(5,'admin1','admin1',NULL,'USER',0),(6,'admin2','admin2',NULL,'VIP',1),(7,'admin3','admin3',NULL,'VIP',0),(8,'admin4','admin4',NULL,'USER',0),(9,'admin5','admin5',NULL,'USER',0),(10,'admin6','admin6',NULL,'USER',0),(11,'admin7','admin7',NULL,'USER',0),(12,'admin8','admin8',NULL,'USER',0),(13,'hello1','hello1',NULL,'USER',0),(14,'hello2','hello2',NULL,'USER',0),(15,'hello3','hello3',NULL,'USER',0),(16,'hello4','hello4',NULL,'USER',0),(17,'hello5','hello5',NULL,'USER',0),(18,'hello6','hello6',NULL,'USER',0),(19,'徐博文','sb',NULL,'USER',0),(20,'张三','张三',NULL,'USER',0);
...
-- Dump completed on 2023-05-23 20:54:41
